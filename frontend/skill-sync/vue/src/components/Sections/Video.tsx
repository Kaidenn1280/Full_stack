...
const VideosSection = ({ isActive }: VideosSectionProps) => {
  ...
  return (
    ...
    <section id="videos" className={`page-section vid-lib-section ${isActive ? "active" : ""}`}>
      ...
      {/* --- Professional Modal --- */}
      {selectedLesson && (
        <div className="vid-modal-backdrop" onClick={() => setSelectedLesson(null)}>
            ...
            <div className="vid-modal-content">
              ...
              <div className="vid-desc">
                ...
                <p>
                  ...
                  of {selectedLesson.subject} fundamentals.
                </p>
              </div>
            </div>

            <div className="vid-modal-actions">
              <button className="vid-btn-primary">Start Watching</button>
              <FavoriteButton 
